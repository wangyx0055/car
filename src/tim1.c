...
void FTB_EVAL_TIM1_PWMInit(void);
...
int main (void){
  ...
  The following Table  describes the TIM1 Channels states:
              -----------------------------------------------
   |XXX|          | Step1 | Step2 | Step3 | Step4 | Step5 | Step6 |
   ----------------------------------------------------------
   |XXX|Channel1  |   1   |   0   |   0   |   0   |   0   |   1   |
   ----------------------------------------------------------
   |XXX|Channel1N |   0   |   0   |   1   |   1   |   0   |   0   |
   ----------------------------------------------------------
   |XXX|Channel2  |   0   |   0   |   0   |   1   |   1   |   0   |
   ----------------------------------------------------------
...
TIM1CLK=72MHz
Prescaler=0x0
TIM1 counter clock = 72MHz
TIM1 ARR Register = 999
TIM1 Frequency = (TIM1 counter clock) / (ARR + 1)
*/

/* Time Base configuration */
  TIM_TimeBaseStructure.TIM_Prescaler = 0;  /*设置预分频:不分频 72MHz*/
  TIM_TimeBaseStructure.TIM_CounterMode = TIM_CounterMode_Up;/*向上计数模式*/
  TIM_TimeBaseStructure.TIM_Period = 4095; /*定时周期，计数器从0到4095，即4096/
...
void GPIO_Configuration(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10|GPIO_Pin_9|GPIO_Pin_8;                                GPIO_Pin_8|GPIO_Pin_10|GPIO_Pin_12;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;

  GPIO_Init(GPIOA, &GPIO_InitStructure);

  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15|GPIO_Pin_14|GPIO_Pin_13;                                GPIO_Pin_8|GPIO_Pin_10|GPIO_Pin_12;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
